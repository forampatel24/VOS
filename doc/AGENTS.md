...
If any implementation decision conflicts with these principles, prioritize architectural correctness, modularity, and accurate operating system behavior over convenience.# AGENT.md
